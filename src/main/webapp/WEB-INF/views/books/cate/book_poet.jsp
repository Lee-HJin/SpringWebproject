...
<head>
<meta charset="UTF-8">
<title>메인_시 도서부분</title>

<!-- 베스트셀러 css -->

<link rel="stylesheet" href="/webproject/resources/common/css/bnlBSList2.css"
	type="text/css">
			...
			<div class="cate_comm">
				...
				<ul class="cate_d1">
					...
					<li id="kidsCate_821" class="cate_d1_li "><a
						...
						onmouseout="javascript:toggleDisplay2('01')">에세이</a> <!-- 소분류 -->
							...
							<div class="pos_rel">
								...
								<ul>
									...
									<li class="cate_d2_link "><a
										href="/front/product/bookCategoryMain.do?cateId=822">에세이모음집</a></li>

									<li class="cate_d2_link "><a
										href="/front/product/bookCategoryMain.do?cateId=826">예술에세이</a>
									</li>

									<li class="cate_d2_link "><a
										href="/front/product/bookCategoryMain.do?cateId=827">유머/풍자에세이</a>
									</li>

									<li class="cate_d2_link "><a
										href="/front/product/bookCategoryMain.do?cateId=831">명언/명상에세이</a>
									</li>

									<li class="cate_d2_link "><a
										href="/front/product/bookCategoryMain.do?cateId=835">사진/그림에세이</a>
									</li>
